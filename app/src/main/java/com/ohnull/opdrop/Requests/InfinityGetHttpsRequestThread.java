...
public class InfinityGetHttpsRequestThread extends Thread implements IRequestThread {
    ...
    public InfinityGetHttpsRequestThread(ExUrl exUrl, String cookieStr, int threadNum) {
        this.exUrl = exUrl;
        ...
        EDebug.l("InfinityGetHttpsRequestThread: INIT -> #" + threadNum + " | " + exUrl.getUrl());
    }
    ...
    @Override
    public void run() {
        EDebug.l("InfinityGetHttpsRequestThread: RUN -> #" + threadNum + " | " + exUrl.getUrl());
        Random rnd = new Random();
        String finalStr = "";
        ...
        while (!stopThread) {
            try {
                ...
                out.write("GET " + uri.getPath() + "?" + uri.getQuery() + prepareRndGetDataEnd() + " HTTP/1.1\r\n");
                ...
                try {
                    ...
                    finalStr = in.readLine();
                }catch (Exception e){
                    //EDebug.l(e);
                }

                EDebug.l("#" + threadNum +" | url: " + exUrl + " | code: " + finalStr + " | sleepCounter: " + sleepCounter);
            } catch (Exception e) {
                //EDebug.l(e);
                try {
        ...
        EDebug.l("InfinityGetRequestSocketThread: FINISHED -> #" + threadNum + " | " + exUrl.getUrl());
    }

    private String prepareRndGetDataEnd() {
